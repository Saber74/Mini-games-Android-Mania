...
public class Space_Bullet {
    ...
    public Space_Bullet(float x, float y, float width, int type) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.type = type;
        if (type == PLAYER) { // will load a texture that points the bullets towards the enemies
            bullet_sprite = new Texture("android/assets/SpaceInvaders/1.png");
        } else if (type == ENEMY) { // will load a texture that points the bullets towards the player
            bullet_sprite = new Texture("android/assets/SpaceInvaders/1flipped.png");
        }
    ...
    public void reflect() { // will reflect the bullet towards the enemies
        ...
        bullet_sprite = new Texture("android/assets/SpaceInvaders/1.png"); // changes the bullet sprite
        ...
        Space_Main.bullets.add(this); // added to the players bullets
    }
