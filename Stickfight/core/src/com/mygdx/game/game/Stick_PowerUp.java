...
public class Stick_PowerUp {
    ...
    public Stick_PowerUp() {
        // texture arraylist which stores the textures of the different powerups
        Texture[] powerups = {new Texture("Assets/spiritBomb.png"), new Texture("Assets/invincible.png"), new Texture("Assets/heart.png")};
