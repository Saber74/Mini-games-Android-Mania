...
public class Test1 extends ApplicationAdapter {
    ...
    public void create() {
        ...
        pinky = new Sprite(new Texture("Assets/Zero/Walk/15.png"));
        pinky.setPosition(0, 300);

        flappy = new Sprite(new Texture("Assets/Zero/Jump/4.png"));
        flappy.setPosition(300, 300);
        flappy.setSize(128,128);

        babyPinky = new Sprite(new Texture("Assets/Zero/Walk/0.png"));
        ...
        int offset = 25;
        Texture img = new Texture("Assets/Zero/Walk/10.png");	// create new Texture (image)
