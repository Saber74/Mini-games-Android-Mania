...
public class Space_PowerUp {
    ...
    public Space_PowerUp() {
        ...
        Texture[] powerups = {new Texture("android/assets/SpaceInvaders/spiritBomb.png"), new Texture("android/assets/SpaceInvaders/invincible.png"), new Texture("android/assets/SpaceInvaders/Mirror.png"), new Texture("android/assets/SpaceInvaders/powerupHeart.png")};
