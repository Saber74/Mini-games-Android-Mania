...
public class Space_PowerUp {
    ...
    public Space_PowerUp() {
        ...
        Texture[] powerups = {new Texture("SpaceInvaders/spiritBomb.png"), new Texture("SpaceInvaders/invincible.png"), new Texture("SpaceInvaders/Mirror.png"), new Texture("SpaceInvaders/heart.png")};
