...
//first screen to be called and displayed 
//- intro loading screen of ping pong paddle
...
public class IntroAnimation extends ScreenAdapter {
    ...
    public void render(float delta){
        ...
        //count each time the animation runs
        if(introAnimation.isAnimationFinished(stateTime)){
            animationCounter++;
            stateTime = 0;
        }

        //run the animation 4 times before continuing to game screen
